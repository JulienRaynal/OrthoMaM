...
# On crée un tableau qui va contenir toutes les distances entre les noeuds pour tous les arbres phylogénétiques
df <- data.frame(
        id_tree = integer(),
...
qA <- function() {
  ...
  lapply(files, function(x) {
    # Lecture de l'arbre
    tree <- read.tree(x)
    # Recherche des index de nos espèces d'intérêt dans les feuilles de nos abres
    ...
    # On récupère les ancêtres d'abord des Primates (humain et macaque) et Rodentia (souris et rat) pour finalement
    # récupérer l'ancêtre commun aux deux ancêtres communs, Euarchontoglires, grâce à la fonction getMRCA
